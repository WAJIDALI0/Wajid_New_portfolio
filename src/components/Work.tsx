...
const projects = [
  {
    ...
    link: "https://photo-resizer-k1fivh4r7-wajidali0s-projects.vercel.app"
  },
  {
                        ...
                        {(project as any).link && (
                          <div className="carousel-tools" style={{ marginTop: "15px" }}>
                            <a 
                              ...
                              target="_blank" 
                              style={{ color: "#fff", textDecoration: "underline", display: "inline-flex", alignItems: "center", gap: "5px" }} 
                              data-cursor="disable"
                            >
